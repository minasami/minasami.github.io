(function () {
  ...
  ready(function () {
    ...
    section.innerHTML = '<div class="wrap"><div class="box"><div class="eyebrow">Current deployment evidence</div><h2>GitHub-integrated, Vercel-hosted and Supabase-backed.</h2><p class="lead">Medicine Support Hub now has stronger technical delivery evidence: a connected GitHub repository, Vercel hosting workflow and Supabase database foundation.</p><div class="grid"><div class="item"><strong>GitHub</strong><span>Repository: minasami/medicine-support-hub</span></div><div class="item"><strong>Vercel</strong><span>Hosted deployment workflow</span></div><div class="item"><strong>Supabase</strong><span>Database-backed architecture</span></div><div class="item"><strong>Proof boundary</strong><span>Do not infer clinical production use without added evidence.</span></div></div><p><a href="https://github.com/minasami/medicine-support-hub" target="_blank" rel="noopener">Open GitHub repository →</a></p></div></div>';
