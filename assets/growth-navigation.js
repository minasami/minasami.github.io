(function () {
  ...
  function addStyles() {
    ...
    style.textContent = '.growth-dock{position:fixed;left:18px;bottom:18px;z-index:9997;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.growth-dock__toggle{border:0;border-radius:999px;background:#1463ff;color:#fff;padding:11px 15px;font-weight:900;cursor:pointer;box-shadow:0 12px 28px rgba(15,23,42,.22)}.growth-dock__panel{display:none;position:absolute;left:0;bottom:48px;width:240px;border:1px solid rgba(100,116,139,.25);border-radius:18px;background:var(--card,#fff);color:var(--ink,#172033);box-shadow:0 24px 70px rgba(15,23,42,.22);padding:14px}.growth-dock__panel.open{display:grid;gap:8px}.growth-dock__panel strong{font-size:.9rem}.growth-dock__panel a{font-size:.86rem;font-weight:800;text-decoration:none}.growth-dock__panel a:hover{text-decoration:underline}@media(max-width:720px){.growth-dock{left:12px;bottom:82px}.growth-dock__panel{width:min(240px,calc(100vw - 28px))}}';
